        ...
        return Commands.literal(commandName)
                .then(Commands.literal("join")
                        .then(Commands.argument("teamName", StringArgumentType.greedyString())
                                ...
                                .requires(commandSourceStack -> commandSourceStack.getSender().hasPermission("battle-plugin.team.join"))
                ...
                .then(Commands.literal("leave")
                        .requires(commandSourceStack -> commandSourceStack.getSender().hasPermission("battle-plugin.team.leave"))
                        .executes(commandContext -> runLeave(teamService, playerService, commandContext)))
                .then(Commands.literal("list")
                        .requires(commandSourceStack -> commandSourceStack.getSender().hasPermission("battle-plugin.team.list"))
                ...
                .then(Commands.literal("remove")
                        .requires(commandSourceStack -> commandSourceStack.getSender().hasPermission("battle-plugin.team.remove"))
                        .then(Commands.argument("teamName", StringArgumentType.greedyString())
